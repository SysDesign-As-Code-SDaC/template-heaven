...
#### Basic Usage
```python
from test-project-2 import create_app
from test-project-2.core.models import User
...
kubectl get pods -l app=test-project-2

# View logs
kubectl logs -l app=test-project-2
```
