...
#### Basic Usage
```python
from test-yaml-final import create_app
from test-yaml-final.core.models import User
...
```bash
# Build Docker image
docker build -t test-yaml-final:latest .
...
kubectl get pods -l app=test-yaml-final

# View logs
kubectl logs -l app=test-yaml-final
```
