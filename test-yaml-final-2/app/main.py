...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    # Startup
    logger.info("Starting test-yaml-final-2 application")
    ...
    # Shutdown
    logger.info("Shutting down test-yaml-final-2 application")


def create_app() -> FastAPI:
    """Create and configure FastAPI application."""
    app = FastAPI(
        title="test-yaml-final-2",
