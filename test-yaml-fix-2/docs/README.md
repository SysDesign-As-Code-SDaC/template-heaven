...
#### Basic Usage
```python
from test-yaml-fix-2 import create_app
from test-yaml-fix-2.core.models import User
...
```bash
# Build Docker image
docker build -t test-yaml-fix-2:latest .
...
kubectl get pods -l app=test-yaml-fix-2

# View logs
kubectl logs -l app=test-yaml-fix-2
```
