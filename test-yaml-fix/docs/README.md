...
#### Basic Usage
```python
from test-yaml-fix import create_app
from test-yaml-fix.core.models import User
...
```bash
# Build Docker image
docker build -t test-yaml-fix:latest .
...
kubectl get pods -l app=test-yaml-fix

# View logs
kubectl logs -l app=test-yaml-fix
```
