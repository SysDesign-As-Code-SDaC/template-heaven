# Cursor Rules for Template Heaven

This directory contains comprehensive Cursor Rules for the Template Heaven project, a multi-branch template repository system that organizes technology stack templates across 24 different categories.
...
- **Purpose**: Provides comprehensive overview of the multi-branch architecture, stack categories, and key tools
- **Key Topics**: Branch structure, stack categories, key directories, working with templates

### 2. Python Coding Standards
**File**: `python-standards.mdc`
- **Scope**: Python files (`*.py`)
- **Purpose**: Enforces comprehensive Python coding standards with docstrings, type hints, and best practices
- **Key Topics**: Documentation standards, type hints, error handling, logging, configuration management

### 3. Multi-Branch Workflow
**File**: `multi-branch-workflow.mdc`
- **Scope**: Documentation and script files (`*.md`, `*.yml`, `*.yaml`, `*.sh`, `*.ps1`)
- **Purpose**: Defines Git workflow patterns, branch management, and template synchronization practices
- **Key Topics**: Branch architecture, commit standards, automated workflows, trend detection

### 4. Documentation Standards
**File**: `documentation-standards.mdc`
- **Scope**: Documentation files (`*.md`, `*.rst`, `*.txt`)
- **Purpose**: Establishes comprehensive documentation requirements and README standards
- **Key Topics**: README templates, technical documentation, code documentation, maintenance

### 5. Testing & Validation
**File**: `testing-validation.mdc`
- **Scope**: Test files and Python files (`*.py`, `test_*.py`, `*_test.py`, `*.spec.js`, `*.test.js`)
...
- **Project Structure**: Provides context for all development work

### File-Specific Rules
- **Python Standards**: Applied to all Python files for consistent code quality
...
- **Architecture Understanding**: Complete project structure and multi-branch system
- **Code Quality**: Python standards with docstrings, type hints, and error handling
...
- **Comprehensive Documentation**: Detailed docstrings, type hints, and dependency documentation
- **Error Handling**: Proper exception handling and logging throughout
- **Security**: Best practices for secret management and security scanning

### Integration Focus
- **Multi-Branch Architecture**: Support for 24 different technology stack categories
...
These rules are automatically applied by Cursor based on file types and scope. They provide:

1. **Context Awareness**: Understanding of the Template Heaven project structure
...
- **Stack Catalog**: [STACK_CATALOG.md](../../STACK_CATALOG.md) - Available technology stacks
- **Project Status**: [PROJECT_STATUS.md](../../PROJECT_STATUS.md) - Current development status
- **Branch Strategy**: [docs/BRANCH_STRATEGY.md](../../docs/BRANCH_STRATEGY.md) - Architecture details
- **Contributing Guide**: [CONTRIBUTING.md](../../CONTRIBUTING.md) - Contribution guidelines

## 🚨 Important Notes

- **Private Repository**: This is for internal use only, never fork public templates directly
- **Manual Validation**: Always test implementations manually, avoid automated scripts
- **Comprehensive Documentation**: Include docstrings, type hints, and dependency documentation
- **Quality Standards**: Maintain high code quality with proper error handling and logging
- **Security**: Follow security best practices for secrets and external integrations

---

**Last Updated**: 2024-01-15  
**Version**: 1.0  
**Maintainer**: Template Heaven Team
